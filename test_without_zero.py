...
from solver_without_zero import Solver
...
if __name__ == '__main__':
    ...
    config.mol_data_dir = 'data/KRAS_wp_docking_compounds(68885)_25nodes.sparsedataset'
    ...
    config.test_sample_size = 4859
    config.batch_size = 64
    config.z_dim = 4
    config.test_epoch = 44
    # MolGAN
    # config.saving_dir = r"results/GAN/20240308_121437/train/"
    # config.saving_dir = r"results/GAN/20211014_151730/train"
    config.saving_dir = r"results/GAN/20240819_092919/train/"
    # Quantum
    # config.saving_dir = r"results/quantum-GAN/20231116_171127/train"
    # metric
    config.metric = "logp,sas,qed,unique,dc"

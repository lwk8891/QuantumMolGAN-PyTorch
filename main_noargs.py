...
if __name__ == '__main__':
    ...
    # config.mol_data_dir = 'data/prap_24nodes.sparsedataset'
    # config.mol_data_dir = 'data/prap_29nodes.sparsedataset'
    # config.mol_data_dir = 'data/PPAR_WP_Screening_Compounds(31026)_20nodes.sparsedataset'
    ...
    # config.lambda_wgan = 0.6
    # weight decay
    # config.decay_every_epoch = 60
    # config.gamma = 0.1
    # metric
    # config.metric = "logp,sas,qed"
